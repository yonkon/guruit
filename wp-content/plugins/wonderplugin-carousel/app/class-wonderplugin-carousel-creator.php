							...
							<table class="wonderplugin-form-table-noborder">
								...
								<tr>
									...
									<td>
										...
										<script language="JavaScript">
										jQuery(document).ready(function(){
											jQuery("#wonderplugin-carousel-showhoveroverlay").change(function(){
												if (jQuery("#wonderplugin-carousel-showhoveroverlay").is(':checked'))
													...
													jQuery("#wonderplugin-carousel-displayhoveroverlayimage").attr("src", "");											
											});
